...
| fin set | one fin's share of fin normal force at 5 deg, 1.5 ultimate | 200 N | 0.80 mm | minimum gauge | 563.14x | 12.3 MPa | 25* | 74 MPa | 336 Hz | 362 g | 8.53e-04 | PASS |
...
| stage 4 tank | carries 23.1 kg propellant at 3.2 g | 1788 N | 0.80 mm | minimum gauge | 66.21x | 12.1 MPa | 13 | 17 MPa | 1205 Hz | 232 g | 2.30e-04 | PASS |
...
|---|---|---|---|---|
| nozzle | revolve | -0.324 m | 324 mm | 0.95 kg |
...
21 of 21 internal cross-checks agree, comparing numbers the packet already reports against each other: gross mass against the stack it lists; one structural coefficient across every stage; each component's mass over its volume against the density of the alloy the design selected; every in-line part meeting its neighbour without overlap or gap. Six defects in this packet were of exactly that shape and every one was invisible to the tests, because each individual model was right and only the connection between them was wrong.
