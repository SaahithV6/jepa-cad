...
| fin set | one fin's share of fin normal force at 5 deg, 1.5 ultimate | 200 N | 0.80 mm | minimum gauge | 563.14x | 12.3 MPa | 25* | 74 MPa | 347 Hz | 119 g | 2.81e-04 | PASS |
...
| interstage 3/4 | transmits lower-stage thrust to the stage above | 4981 N | 0.80 mm | minimum gauge | 23.36x | 34.3 MPa | 81* | 1702 MPa | 2613 Hz | 41 g | 4.97e-05 | PASS |
...
The six analysed parts stacked nose-forward: 1.289 m in 10 sections, 1332 g of structure, centre of gravity 0.464 m from the aft end, Ixx 1.448e-01 and Izz 2.253e-03 kg m^2.

These are **coupons, not the vehicle**. Body radius is clamped to 50 mm so the parts stay meshable, while this mission's reference diameter is 670 mm -- a factor of 8.0 in radius, so the coupons carry 1332 g against the 466 kg of structure the planner sized. The stresses and modes above are about representative sections; the mass properties that describe the flight vehicle are below.
...
| flight component stress | **REQUIRED** | analysed as coupons at 42 mm radius against a flight radius of 335 mm, a factor of 8.0; the flight parts themselves are not analysed |

2 check(s) marked REQUIRED are neither passed nor failed: they name real work this packet cannot do. Claiming they pass would report checks that never ran; claiming they fail would suggest defects where there are none.

- **flexible mode stabilisation** -- slosh below crossover; phase stabilisation required and not verified here.
- **flight component stress** -- analysed as coupons at 42 mm radius against a flight radius of 335 mm, a factor of 8.0; the flight parts themselves are not analysed.


Allowable 700 MPa, derived from inconel-718 at 1030 MPa (typical (non-statistical)) with a yield factor of safety of 1.25 and a 0.85 knockdown. All 10 coupons passed: **True**. Assembly checks failed: **0**. Requirements unverified: **2**.
