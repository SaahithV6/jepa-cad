...
| usable control band | No usable band: flying the vehicle needs at least 4.62 Hz while the slosh caps bandwidth at 0.50 Hz. This vehicle needs notch filtering, slosh baffles, or a different configuration -- it cannot be flown by a plain autopilot. |
